...
import com.test.tools.javac.api.BasicJavacTask;
import com.test.tools.javac.file.CacheFSInfo;
...
import com.test.tools.javac.main.CommandLine.UnmatchedQuote;
...
public class Main {
    ...
    public Result compile(String[] argv, Context context) {
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "com.test.tools.javac.Main";
            showClass(showClass);
        }
    ...
    public static final String javacBundleName =
        "com.test.tools.javac.resources.javac";
}
