...
package com.test.tools.javac.launcher;
...
import com.test.tools.javac.resources.LauncherProperties.Errors;
...
public class Main {
    ...
    private static final String bundleName = "com.test.tools.javac.resources.launcher";
