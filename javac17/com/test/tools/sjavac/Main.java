...
import static com.test.tools.sjavac.options.Option.STARTSERVER;

import java.util.Arrays;

import com.test.tools.sjavac.client.ClientMain;
import com.test.tools.sjavac.server.ServerMain;
