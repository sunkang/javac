...
import com.test.tools.javac.code.Symbol.RootPackageSymbol;
import com.test.tools.javac.code.Symbol.TypeSymbol;
import com.test.tools.javac.code.Symbol.VarSymbol;
import com.test.tools.javac.code.Type.BottomType;
import com.test.tools.javac.code.Type.ClassType;
import com.test.tools.javac.code.Type.ErrorType;
import com.test.tools.javac.code.Type.JCPrimitiveType;
import com.test.tools.javac.code.Type.JCVoidType;
import com.test.tools.javac.code.Type.MethodType;
import com.test.tools.javac.code.Type.UnknownType;
import com.test.tools.javac.code.Types.UniqueType;
        ...
        unnamedModule = new ModuleSymbol(names.empty, null) {
                {
                    ...
                    com.test.tools.javac.code.Directive.RequiresDirective d =
                            new com.test.tools.javac.code.Directive.RequiresDirective(java_base,
                                    EnumSet.of(com.test.tools.javac.code.Directive.RequiresFlag.MANDATED));
                    requires = List.of(d);
                }
                @Override
