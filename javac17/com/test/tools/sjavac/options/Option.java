...
package com.test.tools.sjavac.options;
...
import com.test.tools.sjavac.CopyFile;
 ...
 * option values, refer to com.test.tools.sjavac.options.Options.
 *
...
public enum Option {
    ...
    TR("-tr", "Translate resources") {
        ...
        protected void processMatching(ArgumentIterator iter, OptionHelper helper) {
            ...
            //   .prop=com.test.tools.javac.smart.CompileProperties
            //   .idl=com.test.corba.CompileIdl
