...
import com.test.tools.javac.code.Symbol.MethodHandleSymbol;
import com.test.tools.javac.code.Types.SignatureGenerator.InvalidSignatureException;
...
import com.test.tools.javac.code.Attribute;
...
import com.test.tools.javac.comp.LambdaToMethod.LambdaAnalyzerPreprocessor.*;
import com.test.tools.javac.comp.Lower.BasicFreeVarCollector;
...
import static com.test.tools.javac.comp.LambdaToMethod.LambdaSymbolKind.*;
            ...
            Symbol translate(final Symbol sym, LambdaSymbolKind skind) {
                ...
                switch (skind) {
                    ...
                    case LOCAL_VAR:
                        ...
                        // Because method com.test.tools.javac.jvm.Code.fillExceptionParameterPositions and
                        // com.test.tools.javac.jvm.Code.fillLocalVarPosition would use it.
