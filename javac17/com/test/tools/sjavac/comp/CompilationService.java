...
package com.test.tools.sjavac.comp;
...
import com.test.tools.javac.api.JavacTool;
import com.test.tools.javac.main.Main;
import com.test.tools.javac.main.Main.Result;
import com.test.tools.javac.util.Context;
import com.test.tools.javac.util.Dependencies;
import com.test.tools.javac.util.ListBuffer;
import com.test.tools.sjavac.Log;
import com.test.tools.sjavac.Util;
import com.test.tools.sjavac.comp.dependencies.NewDependencyCollector;
import com.test.tools.sjavac.comp.dependencies.PublicApiCollector;
import com.test.tools.sjavac.server.CompilationSubResult;
import com.test.tools.sjavac.server.SysInfo;
                ...
                if (explicitJFOs.size() > 0) {
                    ...
                    JavacTaskImpl task =
                            (JavacTaskImpl) compiler.getTask(new PrintWriter(stderrLog),
                                                             ...
                                                             explicitJFOs,
                                                             context);
                    sfm.setSymbolFileEnabled(!com.test.tools.javac.util.Options.instance(context).isSet("ignore.symbol.file"));
