...
package com.test.tools.javac.code;
...
import com.test.tools.javac.code.Attribute.TypeCompound;
...
import com.test.tools.javac.code.Type.CapturedType;
import com.test.tools.javac.code.Type.ClassType;
import com.test.tools.javac.code.Type.ErrorType;
import com.test.tools.javac.code.Type.ForAll;
import com.test.tools.javac.code.Type.MethodType;
import com.test.tools.javac.code.Type.PackageType;
import com.test.tools.javac.code.Type.TypeVar;
import com.test.tools.javac.code.Type.UndetVar;
import com.test.tools.javac.code.Type.Visitor;
import com.test.tools.javac.code.Type.WildcardType;
import com.test.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import com.test.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
import com.test.tools.javac.code.Symbol.VarSymbol;
import com.test.tools.javac.code.Symbol.MethodSymbol;
import com.test.tools.javac.code.Type.ModuleType;
import com.test.tools.javac.code.TypeMetadata.Entry.Kind;
import com.test.tools.javac.comp.Annotate;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link com.test.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
                ...
                final TypeAnnotationPosition pos)
        {
            ...
            if (type.hasTag(TypeTag.TYPEVAR)) {
                ...
                // UnionClassType uct = (com.test.tools.javac.code.Type.UnionClassType)type;
                         ...
                         ListBuffer<TypePathEntry> location)
        {
            ...
            // com.test.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
