...
*/
// Code duplicated in com.test.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // com.test.tools.javac.jvm.Gen.genCatch, we first use this to hold
    // the catch type's constant pool entry index.  Then in
    // com.test.tools.javac.jvm.Code.fillExceptionParameterPositions we
