...
import com.test.tools.javac.tree.TreeInfo.PosKind;
...
import com.test.tools.javac.jvm.Code.*;
import com.test.tools.javac.jvm.Items.*;
...
import static com.test.tools.javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new com.test.tools.javac.model.FilteredMemberList(clazz.members())) {
