...
package com.test.tools.javac.tree;
...
import com.test.source.doctree.AttributeTree.ValueKind;
import com.test.source.doctree.DocTree;
import com.test.source.doctree.DocTree.Kind;
import com.test.source.doctree.EndElementTree;
import com.test.source.doctree.IdentifierTree;
import com.test.source.doctree.ReferenceTree;
import com.test.source.doctree.StartElementTree;
import com.test.source.doctree.TextTree;
import com.test.source.util.DocTreeFactory;
import com.test.tools.javac.api.JavacTrees;
import com.test.tools.javac.parser.ParserFactory;
import com.test.tools.javac.parser.ReferenceParser;
import com.test.tools.javac.parser.Tokens.Comment;
import com.test.tools.javac.tree.DCTree.DCAttribute;
import com.test.tools.javac.tree.DCTree.DCAuthor;
import com.test.tools.javac.tree.DCTree.DCComment;
import com.test.tools.javac.tree.DCTree.DCDeprecated;
import com.test.tools.javac.tree.DCTree.DCDocComment;
import com.test.tools.javac.tree.DCTree.DCDocRoot;
import com.test.tools.javac.tree.DCTree.DCDocType;
import com.test.tools.javac.tree.DCTree.DCEndElement;
import com.test.tools.javac.tree.DCTree.DCEntity;
import com.test.tools.javac.tree.DCTree.DCErroneous;
import com.test.tools.javac.tree.DCTree.DCHidden;
import com.test.tools.javac.tree.DCTree.DCIdentifier;
import com.test.tools.javac.tree.DCTree.DCIndex;
import com.test.tools.javac.tree.DCTree.DCInheritDoc;
import com.test.tools.javac.tree.DCTree.DCLink;
import com.test.tools.javac.tree.DCTree.DCLiteral;
import com.test.tools.javac.tree.DCTree.DCParam;
import com.test.tools.javac.tree.DCTree.DCProvides;
import com.test.tools.javac.tree.DCTree.DCReference;
import com.test.tools.javac.tree.DCTree.DCReturn;
import com.test.tools.javac.tree.DCTree.DCSee;
import com.test.tools.javac.tree.DCTree.DCSerial;
import com.test.tools.javac.tree.DCTree.DCSerialData;
import com.test.tools.javac.tree.DCTree.DCSerialField;
import com.test.tools.javac.tree.DCTree.DCSince;
import com.test.tools.javac.tree.DCTree.DCStartElement;
import com.test.tools.javac.tree.DCTree.DCSummary;
import com.test.tools.javac.tree.DCTree.DCSystemProperty;
import com.test.tools.javac.tree.DCTree.DCText;
import com.test.tools.javac.tree.DCTree.DCThrows;
import com.test.tools.javac.tree.DCTree.DCUnknownBlockTag;
import com.test.tools.javac.tree.DCTree.DCUnknownInlineTag;
import com.test.tools.javac.tree.DCTree.DCUses;
import com.test.tools.javac.tree.DCTree.DCValue;
import com.test.tools.javac.tree.DCTree.DCVersion;
...
import com.test.tools.javac.util.StringUtils;
