...
import com.test.tools.javac.main.CommandLine;
import com.test.tools.sjavac.Transformer;

/**
 * This class is used to decode sjavac options.
 * See com.test.tools.sjavac.options.Options for example usage.
 *
    ...
    void traverse(String[] args) {
        ...
        while (argIter.hasNext()) {
            ...
            if (arg.startsWith("-")) {
                ...
                for (com.test.tools.javac.main.Option javacOpt : com.test.tools.javac.main.Option.values()) {
