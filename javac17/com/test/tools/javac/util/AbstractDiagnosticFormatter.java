...
package com.test.tools.javac.util;
...
import com.test.tools.javac.api.DiagnosticFormatter;
import com.test.tools.javac.api.DiagnosticFormatter.Configuration.DiagnosticPart;
import com.test.tools.javac.api.DiagnosticFormatter.Configuration.MultilineLimit;
import com.test.tools.javac.api.DiagnosticFormatter.PositionKind;
import com.test.tools.javac.api.Formattable;
import com.test.tools.javac.code.Lint.LintCategory;
import com.test.tools.javac.code.Printer;
...
import com.test.tools.javac.tree.Pretty;

import static com.test.tools.javac.util.JCDiagnostic.DiagnosticType.*;
