...
import com.test.source.tree.IdentifierTree;
import com.test.source.tree.MemberReferenceTree.ReferenceMode;
import com.test.source.tree.MemberSelectTree;
import com.test.source.tree.TreeVisitor;
import com.test.source.util.SimpleTreeVisitor;
import com.test.tools.javac.code.*;
...
import com.test.tools.javac.code.TypeMetadata.Annotations;
import com.test.tools.javac.code.Types.FunctionDescriptorLookupError;
import com.test.tools.javac.comp.ArgumentAttr.LocalCacheContext;
import com.test.tools.javac.comp.Check.CheckContext;
import com.test.tools.javac.comp.DeferredAttr.AttrMode;
import com.test.tools.javac.comp.MatchBindingsComputer.MatchBindings;
import com.test.tools.javac.jvm.*;
import static com.test.tools.javac.resources.CompilerProperties.Fragments.Diamond;
import static com.test.tools.javac.resources.CompilerProperties.Fragments.DiamondInvalidArg;
import static com.test.tools.javac.resources.CompilerProperties.Fragments.DiamondInvalidArgs;
import com.test.tools.javac.resources.CompilerProperties.Errors;
import com.test.tools.javac.resources.CompilerProperties.Fragments;
import com.test.tools.javac.resources.CompilerProperties.Warnings;
import com.test.tools.javac.tree.*;
import com.test.tools.javac.tree.JCTree.*;
import com.test.tools.javac.tree.JCTree.JCPolyExpression.*;
import com.test.tools.javac.util.*;
import com.test.tools.javac.util.DefinedBy.Api;
import com.test.tools.javac.util.JCDiagnostic.DiagnosticPosition;
import com.test.tools.javac.util.JCDiagnostic.Error;
import com.test.tools.javac.util.JCDiagnostic.Fragment;
import com.test.tools.javac.util.JCDiagnostic.Warning;
import com.test.tools.javac.util.List;

import static com.test.tools.javac.code.Flags.*;
import static com.test.tools.javac.code.Flags.ANNOTATION;
import static com.test.tools.javac.code.Flags.BLOCK;
import static com.test.tools.javac.code.Kinds.*;
import static com.test.tools.javac.code.Kinds.Kind.*;
import static com.test.tools.javac.code.TypeTag.*;
import static com.test.tools.javac.code.TypeTag.WILDCARD;
import static com.test.tools.javac.tree.JCTree.Tag.*;
 ...
 *************************************************************************/
    ...
    private final class TypeAnnotationsValidator extends TreeScanner {
         ...
         * com.test.tools.javac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
