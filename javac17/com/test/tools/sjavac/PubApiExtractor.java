...
import com.test.tools.sjavac.comp.PubapiVisitor;
import com.test.tools.sjavac.comp.SmartFileManager;
import com.test.tools.sjavac.options.Options;
import com.test.tools.sjavac.pubapi.PubApi;
...
public class PubApiExtractor {
    ...
    public PubApiExtractor(Options options) {
        JavacTool compiler = com.test.tools.javac.api.JavacTool.create();
        fileManager = new SmartFileManager(compiler.getStandardFileManager(null, null, null));
        context = new com.test.tools.javac.util.Context();
